...
function App() {
  ...
  const ydoc= useMemo(()=>new Y.Doc(),[]) //it store the changes done in other editor
  ...
  useEffect(() => {
    if(username){
          const provider=new SocketIOProvider("/","monaco",ydoc,{autoConnect:true})//it stablise the connection btw server and user
